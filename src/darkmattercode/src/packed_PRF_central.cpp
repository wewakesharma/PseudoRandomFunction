...
{
    std::cout<<std::endl<<"Time for 1000 runs of first phase:"<<timer_packed_cent_p1<<std::endl;
}
void display_time_p3()
{
    std::cout<<"Time for 1000 runs of third phase:"<<timer_packed_cent_p3<<std::endl;
}