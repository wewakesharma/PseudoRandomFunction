...
void PRF(vector<uint64_t>& K1, PackedZ2<N_SIZE>& x1, vector<uint64_t>& K2,
        PackedZ2<N_SIZE>& x2, std::vector< PackedZ3<81> >& Rmat, PackedZ3<81>& out1Z3,
        PackedZ3<81>& out2Z3, int i)
{
        PackedZ2<N_SIZE> out1_A, out2_A, out1_B, out2_B;
