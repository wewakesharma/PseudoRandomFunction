...
int main()
{
    ...
    //Input generation
    generate_rand_input(input, generator); //passes the address of input, generator and size of input array to the function in head.cpp
    ...
    //create a function that will join outM and outL to create p3_out
    merge_out_LM(outM, outL, p3_out);
    ...
    InnerProdMul2_test(output_p3_alter2,naive_out_p3);
    return 0;
}
