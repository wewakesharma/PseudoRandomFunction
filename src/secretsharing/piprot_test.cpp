...
int main()
{
    ...
    wordPackedVecMatMult(Ra,Rx,RaRx);//compute the matrix vector multiplication of Ra and Rx
    for(int i = 0; i < 4; i++)
    {
        Z[i] = RaRx[i] + Rb[i]; //Z = Ra*Rx + Rb
    }

    //PARTY2=================> generates random values for X and Rx.
    generate_rand_input(X,generator); //generated X is a 4 word (uint64_t) value.
    cout<<endl<<"=====================================Party 2 Begins========================================"<<endl;
    cout<<"Input values generated by Party 2"<<endl;
    //Using X and Rx, compute Mx computed by multProtP2Part1
    multProtP2Part1(X, Rx);
    cout<<endl<<"=====================================Party 2 Ends========================================"<<endl;
