...
\begin{table}[h]
	{
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{|cc|c|c|c|c|c|c|}%8 columns
				...
				\hline
				\multirow{2}{*}{Protocol} & & \multicolumn{3}{c|}{Runtime} & \multirow{2}{*}{Preprocessing} & \multicolumn{2}{c|}{Communication(bits)}\\
				...
				\hline
				\multirow{2}{*}{23-OPRF*} & Key Update & 3.43 & - & \multirow{2}{*}{4.84}& \multirow{2}{*}{768} & \multirow{2}{*}{512} & \multirow{2}{*}{256}\\
