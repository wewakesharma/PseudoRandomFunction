...
In order to further optimize the run-time, we created a lookup table to replace the matrix-vector multiplication in phase 3. Implementing protocol using this method consisted of two substages in phase 3:\\
\begin{itemize}
