...
\begin{table}[htbp]
	...
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\hline
			\textbf{Fully Distributed\cite{darkmatter} (packed)} & 4 & 5 & 2K &  45K\\
			\hline
			\textbf{Fully Distributed (packed)} & 3 & 5 & 6K &  22K\\
			\hline
			\textbf{Fully Distributed (lookup)} & 3 & 5 & 1M &  13K\\
			\hline
			\textbf{OPRF (packed)} & 3 & 5 & 3K &  20K\\
			\hline
			\textbf{OPRF (lookup)} & 3 & 5 & 1M & 11K\\
			\hline
...
\begin{table}[htbp]
	...
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|c|}
			\hline
			\textbf{Protocol} & \textbf{Packed }  &  \textbf{lookup} & \textbf{Runs/sec} & Runtime($\mu$ sec)\\
			\hline
			\hline
...
\begin{table}[htbp]
	...
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|}
			\hline
			\textbf{Protocol} & \textbf{Runs/sec} & Runtime($\mu$ sec) & Computation\\
			\hline
			\hline
			\textbf{Original distributed dark matter} & 24K & 40.56 &210n \\
			\hline
			\textbf{DIDO} &  49K &  20.20& 193n\\
			\hline
			\textbf{DIDO} &  82K &  12.12& 133n\\
			\hline
			\textbf{oPRF} &  53K &  18.66& 135n\\
			\hline
			\textbf{oPRF} &  104K &  9.52& 76n \\
			\hline
