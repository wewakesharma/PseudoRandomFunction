...
\begin{table}[htbp]
	...
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\hline
			\textbf{Centralized wPRF(lookup)} & - & - & 1,069,296 & 9K\\
			\hline
			\textbf{Fully Distributed TCC'18 (packed)} & 3 & 5 & - &  45K$\\
			\hline
			\textbf{Fully Distributed (packed)} & 3 & 5 & - &  22K\\
			\hline
			\textbf{Fully Distributed (lookup)} & 3 & 5 & - &  13K\\
			\hline
			\textbf{OPRF (packed)} & 3 & 5 & - &  20K\\
			\hline
			\textbf{OPRF (lookup)} & 3 & 5 & - & 11K\\
			\hline
