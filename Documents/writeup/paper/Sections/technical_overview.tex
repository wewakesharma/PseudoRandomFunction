...
\begin{table}[htbp]
	...
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\hline
			\textbf{Central wPRF (packed)}  & -  & - & - & $18,432$ \\
			\hline
			\textbf{Centralized wPRF(lookup)} & - & - & 1,069,296 & $8,704$\\
			\hline
			\textbf{Fully Distributed (packed)} & 3 & 5 & - &  $ 55,680$\\
			\hline
			\textbf{Fully Distributed (lookup)} & 3 & 5 & - &  $26,752$\\
			\hline
			\textbf{OPRF (packed)} & 3 & 5 & - &  $(2n+2m+t) bits$	\\
			\hline
			\textbf{OPRF (lookup)} & 3 & 5 & - &  $(2n+2m+t) bits$	\\
			\hline
