...
\begin{table}[htbp]
	...
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|}
			...
			\hline
			\textbf{Fully Distributed wPRF} &  49K &  20.20\\
			\hline
			\textbf{Fully Distributed wPRF(lookup)} &  82K &  12.12\\
			\hline
			\textbf{oPRF} &  53K &  18.66\\
			\hline
			\textbf{oPRF with lookup} &  104K &  9.52 \\
			\hline
			\textbf{Discrete log-based PRF} & 35K & \sout{28.69} \textbf{9.56}\\
			\hline
			
		\end{tabular}
		
		\vspace{-1mm}
		\caption{Optimized protocols runtime with parameters.}
		\label{RuntimeTable}
		%\end{minipage}
	\end{center}
	\vspace{-5mm}
